...
Data set:<br> [**CLICK HERE TO DOWNLOAD**](https://github.com/ewanoleghe/science/Data_df.xlsx)
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
skeetSuba <- dplyr::distinct(skeetSub) 
coordinates(skeetSuba) <- ~ x.axis + y.axis

mod1.kriged <- krige((Total_C) ~ 1, skeetSuba, grid_x_y, model=mod1)
